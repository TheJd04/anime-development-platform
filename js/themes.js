...
const THEMES = {
  ...
  wandandsword: {
    id: 'wandandsword',
    name: 'Wand & Sword',
    tagline: 'Wield the Sword, Master the Wand',
    emoji: '🪄',
    universe: 'Regarden Magic Academy',
    diaryName: 'Grimoire Spells Log',

    device: {
      type: 'grimoire',
      name: 'Magical Grimoire',
      triggerIcon: '📖',
      triggerLabel: 'Spell Grimoire',
      subtitle: 'Regarden Spire Registry',
    },

    ranks: [
      { name: 'Non-Magic Cadet',   xp: 0,     tier: 1 },
      { name: 'Spell Blade Novice', xp: 200,  tier: 1 },
      { name: 'First-Year Mage',   xp: 500,   tier: 2 },
      { name: 'High Class Cadet',  xp: 1000,  tier: 3 },
      { name: 'Dungeon Expeditionist', xp: 2000, tier: 4 },
      { name: 'Spellblade Knight', xp: 3500,  tier: 4 },
      { name: 'Tower Sentinel',    xp: 5500,  tier: 5 },
      { name: 'Archmage Candidate', xp: 8000, tier: 6 },
      { name: 'Magia Vander',      xp: 12000, tier: 6 },
      { name: 'Supreme Magus',     xp: 18000, tier: 'max' },
    ],

    bracketNames: {
      study:    'Spell Incantation Study',
      exercise: 'Sword Stance Workout',
      goals:    'Magical Academy Quotas',
    },
    ...
    guildName: 'Magic Academy Spire',
    collectionName: 'Grimoire Beasts',
    enemyLabel: 'Dungeon Monsters',
    xpName: 'Mana Credits',
    currencyName: 'Gold Crowns',
    streakName: 'Academy Streak',

    mapLocations: [
      {
        id: 'ws-loc-1',
        name: 'Regarden Magical Academy',
        kanji: '魔法学院',
        x: 35, y: 55,
        type: 'Magic Citadel',
        desc: 'The prestigious wizarding academy where Will Serfort trains sword skills despite having zero mana.',
        quests: ['Incantation Theory Study', 'Sword Stance Drill'],
        encounter: 'Will Serfort & Colette',
      },
      {
        id: 'ws-loc-2',
        name: 'Tower of Magia (5 Spires)',
        kanji: '至高の塔',
        x: 50, y: 25,
        type: 'Celestial Spire',
        desc: 'The colossal 5 towers housing the five Magia Vanders who protect the barrier wall.',
        quests: ['Magia Tower Research', 'Barrier Mana Check'],
        encounter: 'Elfaria Alvis & Magia Vanders',
      },
      {
        id: 'ws-loc-3',
        name: 'Dungeon Labyrinth (10th Floor)',
        kanji: '地下迷宮',
        x: 65, y: 70,
        type: 'Underground Labyrinth',
        desc: 'Treacherous underground maze filled with Gargoyles and Fire Salamanders.',
        quests: ['Monster Suppression Sprint', 'Grimoire Card Log'],
        encounter: 'Julius Rein & Rosti',
      },
      {
        id: 'ws-loc-4',
        name: 'Grand Library of Spells',
        kanji: '大図書館',
        x: 20, y: 35,
        type: 'Archive Tower',
        desc: 'Holds thousands of ancient spell scrolls, elemental theory manuscripts, and alchemy recipes.',
        quests: ['Forbidden Spell Reading', 'Elemental Mana Math'],
        encounter: 'Headmistress Workner',
      },
    ],

    motivationalQuotes: [
      { text: 'Even if I can\'t use magic, I will reach the top of the tower with my sword!', source: 'Spellblade Will' },
      { text: 'True strength comes from combining unyielding effort with courage.', source: 'Magia Vander' },
      { text: 'A single strike sharpened ten thousand times can overcome any spell.', source: 'Sword Master' },
      { text: 'Knowledge of spells is the foundation; execution is the victory.', source: 'Academy Professor' },
    ],

    animeHub: {
      title: 'Wistoria: Wand and Sword (杖と剣のウィストリア)',
      rating: '7.85 / 10 (MAL) · 7.9 / 10 (IMDb)',
      animeEpisodes: '12 Episodes (Season 1 Complete)',
      mangaChapters: '44 Chapters (Ongoing)',
      mangaSync: 'Episode 12 corresponds to Manga Chapter 19. Read Chapter 20+ for the Magia Vander Tower arc!',
      studio: 'Actas & Bandai Namco Pictures',
      status: 'Season 2 Announced · Manga Monthly',
      synopsis: 'In a magic-dominated world, Will Serfort cannot cast a single spell. Armed with his heavy sword and superhuman physical talent, he aims to reach the top of the Magia Tower!',
      streamingSites: [
        { name: 'Crunchyroll', icon: '🟠', url: 'https://www.crunchyroll.com/series/G9VHN91DJ/wistoria-wand-and-sword', label: 'Watch Sub & Dub' },
        { name: 'Netflix', icon: '🔴', url: 'https://www.netflix.com', label: 'Stream Select Regions' },
        { name: 'MANGA Plus', icon: '📖', url: 'https://mangaplus.shueisha.co.jp', label: 'Read Manga Chapters' },
      ],
    },
  },
